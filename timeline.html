<style>
  /* --- WRAPPER (Centers the single widget) --- */
  .bujified-wrapper {
    display: flex;
  ...
  .bujified-widget {
    width: 100%;
    max-width: 600px; /* Max width for single view */
    min-width: 320px;
    background: #ffffff;
    padding: 35px;
    border-radius: 15px;
  ...
  .intake-btn {
    display: block; width: 100%; background-color: #32CD32; color: #000; text-decoration: none;
    padding: 14px; border-radius: 6px; font-weight: bold; text-transform: uppercase; font-size: 14px; text-align: center;
    border: 1px solid #28a745;
  }
  .intake-btn:hover { background-color: #28a745; color: white; }
</style>
  ...
  <div class="bujified-widget">
    ...
    <div id="timeResult" class="bujified-result-box">
      ...
      <div id="intakeOption" class="option-container">
        <p style="font-size:12px; color:#666; margin-bottom:5px;">Timeline looks good!</p>
        <a href="https://www.bujified.com/apparel" class="intake-btn">Start Intake Form &rarr;</a>
      </div>
...
<script>
  // Safe Mode: Wrapping logic but exposing checkTimeline to the window
  (function() {
